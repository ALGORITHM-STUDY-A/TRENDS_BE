...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // 토큰 관련 에러
    TOKEN_NOT_INCORRECT(HttpStatus.NOT_FOUND,"TOKEN0001","토큰을 찾을 수 없습니다"),
    TOKEN_EXPIRED(HttpStatus.NOT_FOUND,"TOKEN0002","토큰이 만료되었습니다"),
    TOKEN_NULL(HttpStatus.NOT_FOUND,"TOKEN0003","토큰이 만료되었습니다"),
    ...
    // 기업 관련 에러
    COMPANY_NOT_FOUND(HttpStatus.NOT_FOUND, "COMPANY4001", "기업 정보가 없습니다."),
    COMPANY_USERNAME_DUPLICATE(HttpStatus.MULTI_STATUS,"COMPANY4002","중복된 기업 username입니다");
